...
permalink: /design-develop/media/media-content/   # Add the language shortcode to the end; for example /fundamentals/accessibility-intro/fr
ref: /design-develop/media/media-content/   # Do not change this
layout: default
github:
