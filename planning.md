...
title_html: "<img src='{{ '/content-images/wai-media-guide/planning.png' | relative_url }}' style='float: left; width: 27%; max-width: 173px'> Planning Accessible Audio and Video Media"
