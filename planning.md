...
* What is required in Web Content Accessibility Guidelines (WCAG) at Level A, AA, and AAA. _([WCAG](#WCAG-standards) is explained below.))_
* What is needed to meet user needs, beyond WCAG. If there are no "A"s, then it is not included in WCAG.
...
* In a separate resource: [2.2.2 Pause, Stop, Hide](https://www.w3.org/TR/UNDERSTANDING-WCAG20/time-limits-pause.html) (Level A) For moving, blinking, scrolling, or auto-updating information, all of the following are true:...
* In a separate resource:  [1.4.2 Audio Control](https://www.w3.org/TR/UNDERSTANDING-WCAG20/visual-audio-contrast-dis-audio.html) (Level A) If any audio on a Web page plays automatically for more than 3 seconds, either a mechanism is available to pause or stop the audio, or a mechanism is available to control audio volume...
