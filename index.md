...
{% include image.html src="planning-2.png" alt="" class="small right" %}
...
{% include image.html src="av-content.png" alt="" class="small right" %}
...
{% include image.html src="player.png" alt="" class="small right" %}
